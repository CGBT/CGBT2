		...
		$.suggest = function(input, options) {
			...
			function processKey(e) {
				...
				if ((/27$|38$|40$/.test(e.keyCode) && $results.is(':visible')) ||
					(/^13$|^9$|^32$/.test(e.keyCode) && getCurrentResult())) {
					...
					switch(e.keyCode) {
						...
						case 13: // return							
							...
							// $input.parents("form").get(0).submit();//新版不需要这个！
							break;
			...
			function displayItems(items) {
				...
				$results
					...
					.click(function(e) {
						...
						e.stopPropagation();
						selectCurrentResult(true);
						// $input.parents("form").get(0).submit();//原插件方法
						search();//新版cgbt js提交搜索
					});
			...
			function selectCurrentResult(hide) {
