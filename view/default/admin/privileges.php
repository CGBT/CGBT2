...
<div id="container">
	...
	<div id="content">
		...
		<?php if ($data['current_row']['is_front'] == '1'):?>
		<div class="form_title w150">修改前台权限</div>
		<?php else: ?>
		<div class="form_title w150">修改后台权限</div>
		<?php endif; ?>
				...
				<tr>
					...
					<td>
						<select name="is_front" id="is_front" onchange="change_type();">
							...
							<?php else: ?>
							<option value="0"<?php if ($data['action_name'] == 'edit_action' && $data['current_row']['is_front']=='0'): ?> selected='selected'<?php endif;?>>后台权限</option>
							<?php endif; ?>
						</select>
					</td>
					<td></td>
